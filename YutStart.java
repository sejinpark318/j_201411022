  ...
  public static void startGame1(){
    ...
    if(p1.getNum()==1){
        ...
        if (p1where >=20){
            ...
            makelable2 = List[p2where];
            
            System.out.println(makelable);
            for(int i = 0; i <20 ; i++){
                if (List[i]==makelable && List[i]!= makelable2){
                    JList.get(i).setIcon(smallredicon);
                }
                else if(List[i]!=makelable && List[i]==makelable2){
                    JList.get(i).setIcon(smallblueicon);
                }
                else if(List[i]==makelable && List[i]==makelable2){
                    JList.get(i).setIcon(smallblackicon);}
                else{
